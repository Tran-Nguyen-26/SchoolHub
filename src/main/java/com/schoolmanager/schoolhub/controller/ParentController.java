...
public class ParentController {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<ParentDto> getParentsById(@PathVariable Long id) {
  ...
  public ResponseEntity<List<ParentDto>> getParentsByStudentId(@PathVariable Long studentId) {
